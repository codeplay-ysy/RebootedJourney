...
```
Select按照选择的项存入数据库，Omit忽略选择的项存入数据库。上面Omit一定要忽略ID，否则会发生同Id，主键是不允许重复的。当然可能是我同一时间用了两条指令，如果是单独用，可能不会y
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NjU1ODU1MiwtMjEzODk3MDM1OSwxNz
c4NjYxLDE3NzI3NzUyMiwxODQwOTcyNTEsMzc0ODg0NTgsMTEy
MTIxODYyOSwtMTE0MjcxMjg1NCwxNzE0OTI3MDA2LDEyNDgxOD
E1NTMsLTUwMzIyMzM2NSwxMjI0NDU2MzU1LDkxODU1NzM4MSw2
ODMyNDA0MDAsLTI5MDUxNzM3NiwxNjkxOTM5ODMsLTE4MTk4MT
g2MzAsLTg5OTg4MDE1NSwtNDY2MTAxNzMxLC0yMDkxOTQxMDAy
XX0=
-->