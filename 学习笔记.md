...
```
在输入的时候，单引号要么用来包括整个复合类型，要么就只存在于复合类型中的每个字段中,*但是必须要有*；另外每个字段都可以用双引号括起来。如果值本身就包含逗号或者圆括号，就必须用双引号括起来
```
INSERT INTO on_hand VALUES (ROW('fuzzy dice', 42, 1.99), 1000);	
INSERT INTO on_hand VALUES ('("fuzzy dice
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTMwMjEyMiwtNTAzMjIzMzY1LDEyMj
