...
`/mnt`临时挂载媒体设备，如光驱等
`/home`用户主目录
`/lib`library，存放一些动态链接文件，是应用程序共享的一些文件和函数。可以避免每个程序都需要重复的函数和文件
## Docker！
### **容器使用**
...
## 开始我的PlayPal项目开发！
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDE4MzIwNDAsMTg1Mjg2MTg0OCwtMT
M0ODg5ODI3OSwyMDg4ODU0ODc3LDExMDA5NzU1NDgsLTEzMDk5
MTI3ODEsLTE0OTExODgyNDAsMTcxNzQ5MTkwMCwtMTAwNzU2Nj
U3OCwtMTEzMzk2MDQ2NiwxNTQzMTYzMTcwLDE0ODE2MzQ1OCw5
MDcyNDg3MiwxMTg2MDc0NDU1LDE3OTc3ODY3MjQsLTE5Mjg5OT
g4MDQsMTA4ODgzOTEzNywtOTQ0ODk4Mzg3LC02MTQ3ODEwNTYs
MTk0ODA2MTcyMV19
-->