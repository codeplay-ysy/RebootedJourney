...
| uniqueIndex | 创建唯一索引 |
| check | 创建时检查约束 |
| <- | 写入权限.<-:create只创建、<-:update只更新、<-:false无权限 |


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTYzODAyMzcsMTc3Mjc3NTIyLDE4ND
A5NzI1MSwzNzQ4ODQ1OCwxMTIxMjE4NjI5LC0xMTQyNzEyODU0
LDE3MTQ5MjcwMDYsMTI0ODE4MTU1MywtNTAzMjIzMzY1LDEyMj
